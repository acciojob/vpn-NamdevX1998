...
//        return new ResponseEntity<>(HttpStatus.OK);
    ...
    public ResponseEntity addCountry(@RequestParam int serviceProviderId, @RequestParam String countryName) throws Exception{
        ...
        //in uppercase or lowercase. You should create a new Country object based on the given country name
        //and add it to the country list of the service provider. Note that the user attribute of the country
